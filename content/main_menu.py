...
MENU_MESSAGES = {
    ...
    States.REGISTRATION: Event(
        Text(
            text="Регистрация участников и получение номеров на соревнования будет проходить в: \n"
            "\n"
            "- пт 16:00-17:00 во время open-air`а на площади около Ярмарки, ул.Совнаркомовская, д.13\n"
            "- сб 9:00-10:00 до начала занятий в студии SDS, ул.Б.Покровская, д.7\n"
            "\n"
            "Если Вы не приобрели абонементы, то можете приобрести разовое "
            "участие на вечеринки, занятия, соревнования или на день",
            keyboard=[
                [Button(text="Цены", source=States.PRICE)],
                [menu_button],
            ],
    ...
    States.DINNER: Event(
        ...
        Text(
            text="В студии предусмотрен  бесплатный чай и платный кофе в чайной зоне, есть микроволновка,"
